...
class _ImgWidgetState extends State<ImgWidget> with TickerProviderStateMixin {
  late ImgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImgModel());
          ...
          child: SizedBox(
            ...
            child: Stack(
              children: [
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 16.0, 0.0),
                          child: Text(
                            'Espécie: Mosca-Branca.\n\nSuga a seiva da planta e injeta toxinas, favorecendo a presença de fungos, e pode causar viroses.',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
                ...
                Align(
                  alignment: const AlignmentDirectional(0.22, -1.06),
                  child: ClipRRect(
